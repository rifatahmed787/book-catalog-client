...
const WhiteButton = ({ text }: BrandButton) => {
  return (
    <>
      <button
        type="button"
        className="relative inline-flex items-center justify-center px-5 py-3 overflow-hidden font-display-Poppins font-medium  text-regular border-none bg-brand rounded-lg group"
      >
