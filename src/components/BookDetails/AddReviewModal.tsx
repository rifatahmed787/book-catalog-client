  ...
  return (
    <>
      <Button
        ...
        className=" mt-7 text-white text-base  font-semibold bg-primary  px-[40px] md:px-[40px]  py-[10px]  md:py-[15px] "
      ...
      >
        <Modal.Header className="">
          <h1
            className="px-7 text-primary   font-anton  text-[20px] md:text-[30px]   font-normal 
